      ...
      <div className="p-4 flex items-start justify-between gap-3">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 flex-wrap mb-1">
            ...
            {lead.whatsapp_found ? (
              <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-mono bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 flex-shrink-0">WhatsApp</span>
            ) : (
          ...
          <div className="flex-1 px-6 py-6 space-y-5 overflow-y-auto">
            <div>
              ...
              <input type="text" value={niche} onChange={(e) => setNiche(e.target.value)}
                onKeyDown={(e) => e.key === "Enter" && handleHunt()} placeholder="e.g. fashion boutique"
            ...
            <div>
              ...
              <input type="text" value={city} onChange={(e) => setCity(e.target.value)}
                onKeyDown={(e) => e.key === "Enter" && handleHunt()} placeholder="e.g. Lekki, Surulere..."
                className="w-full bg-[#121214] border border-white/10 rounded px-3.5 py-2.5 text-sm text-white/80 placeholder-white/20 font-mono focus:outline-none focus:border-[#D4AF37]/50 transition-all duration-200" />
            </div>
